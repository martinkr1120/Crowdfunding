...
<body>
	...
	<div class="col-sm-8">
		<div class=error>
			<h3>
				<img src="<c:url value="/resources/image/Error-405.png"/>"
					alt="Image"> Dear <strong>Guest</strong>, You are not
				authorized to access this page, Please Register or Login with your account! <a
