...
<body>
	...
	<div class="col-sm-6">
		<h1>Donation Page</h1>
		<form class="form-group"action="<c:url value='/donate/${user.id}'/>" method="post">
			<fieldset>
				<legend>How much do you want to donate?</legend>
				<p>
					To Creator: ${user.firstName} ${user.lastName} <br />
				</p>
				<p>
					Amount: <br /> <input name="amount" placeholder="amount" />
				</p>
				<p>
